...
with col1:
    ...
    total = len(df)
    fig5, ax5 = plt.subplots(figsize=(2.6,2))
    ax5.text(0.5, 0.5, f"{total:,}", fontsize=26, ha='center', va='center', color="#0A3D91")
    ax5.axis("off")
    st.pyplot(fig5)
...
with col2:
    ...
    fig6, ax6 = plt.subplots(figsize=(2.6,2))
    ax6.text(0.5, 0.5, f"{accelerate_count:,}", fontsize=26, ha='center', va='center', color="#0A3D91")
    ax6.axis("off")
    st.pyplot(fig6)


# =========================================================
# ROW 2 — PIE CHARTS (kompakter)
# =========================================================
...
with b2:
    ...
    fig5b, ax5b = plt.subplots(figsize=(3.2,3))
...
with i1:
    ...
    fig_cluster, axc = plt.subplots(figsize=(3.2,3.2))
